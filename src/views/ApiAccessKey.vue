        ...
        <template #default>
          <div class="flex flex-col gap-3 justify-between z-10 relative">
            <div class="flex flex-col gap-3">
              ...
              <p
                class="text-xl text-center font-semibold tracking-[1em] px-4 py-3 border border-dashed rounded-xl bg-teal-50 dark:bg-teal-500 text-teal-800 dark:text-teal-50 truncate"
              >
                {{ apiKey.key }}
              </p>
              <div class="flex items-center gap-2">
                <UIcon name="i-lucide-calendar-days" class="text-muted text-md dark:text-teal-50" />
                <span class="text-teal-600 font-medium text-lg dark:text-teal-50"
          ...
          <!-- Glassy Decoration -->
          <div
            class="absolute -bottom-24 -right-24 w-64 h-64 rounded-full bg-linear-to-br blur-2xl pointer-events-none transition-all duration-700 ease-in-out group-hover:scale-125 group-hover:rotate-12 group-hover:opacity-70"
            :class="apiKey.gradient"
          ></div>
          <div
            class="absolute -bottom-10 -right-10 w-48 h-48 rounded-full bg-white/10 backdrop-blur-md border border-white/20 pointer-events-none transition-all duration-700 ease-in-out group-hover:scale-110 group-hover:-rotate-12"
          ></div>
        </template>
      </UCard>
    </div>
